             ...
             (cond
               ((= rb-variable 0)
                ...
                (setf (<e-box>-val G) (mdv:vd*
                                       (mdv/calc:quantity-by-dimension-string "kg/s")
                ...
                (setf (<e-box>-val W) (mdv:vd*
                                       (mdv/calc:quantity-by-dimension-string "m/s")
               ...
               ((= rb-variable 1)
                ...
                (setf (<e-box>-val area)
                      (mdv:vd* (mdv/calc:quantity-by-dimension-string "m^2")
               ...
               ((= rb-variable 2)
                ...
                (setf (<e-box>-val p-in)
                      (mdv:vd* (mdv/calc:quantity-by-dimension-string "Pa")
                               (idelchik:pressure
